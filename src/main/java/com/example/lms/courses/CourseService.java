...
public class CourseService {
    ...
    public CourseService(CourseRepository courseRepository, UserRepository userRepository, FileStorageService fileStorageService, CloudinaryService cloudinaryService) {
    ...
    public String uploadCourseImage(UUID courseId, MultipartFile file) {
        ...
        try {
            ...
            String folder = "courses/" + courseId + "/images";

            String filePath = cloudinaryService.uploadFile(file, folder, fileName);
