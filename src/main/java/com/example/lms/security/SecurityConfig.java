...
import com.example.lms.auth.CustomOAuth2UserService;
import com.example.lms.auth.OAuth2LoginSuccessHandler;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://www.mobbyfx.org", "http://localhost:3000")); // Don't use wildcard if allowCredentials is true
        config.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        config.setAllowedHeaders(List.of("Authorization", "Content-Type", "Accept")); // Required for JWT
        config.setExposedHeaders(List.of("Authorization")); // If you want frontend to read this header
        config.setAllowCredentials(false); // Important: Set to FALSE for JWT in headers
